...
var JobManager = module.exports = function JobManager(options){
 ...
 //public members
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        if(options.forceSha256Dblockhash){
            blockHashInvalid = util.reverseBuffer(util.sha256d(headerBuffer, nTime)).toString('hex');
        }
        ...
        _this.emit('share', {
            ...
            difficulty: difficulty,
            shareDiff: Number(shareDiff / shareMultiplier).toFixed(8),
